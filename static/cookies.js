...
function showCookieBanner() {
  ...
  if (isGermanUser()) {
    banner.innerHTML = `
    <div style="position: absolute; z-index: 300; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: var(--background-tile-color); color: var(--text-color); border-radius: 30px; padding: 20px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3); flex-direction: column; justify-content: space-between; width: 600px; max-width: 80vw; max-height: 60svh; text-align: left;">
      <h2 style="color: var(--primary-color); font-size: 24px;">Deine Daten. Deine Wahl.</h2>
      <p style="margin-top: 20px; text-wrap: balance; font-size: 16px;">Um Deine Erfahrung auf unserer Website zu verbessern und den Datenverkehr zu analysieren, verwenden wir funktionale und analytische Cookies. Du hast die Möglichkeit, nicht wesentliche Cookies abzulehnen. Weitere Informationen und zur Anpassung Deiner Einstellungen findest Du in unserer <a href="/privacy" style="color: var(--text-color);">Datenschutzerklärung</a>.</p>
    ...
    banner.innerHTML = `
    <div style="position: absolute; z-index: 300; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: var(--background-tile-color); color: var(--text-color); border-radius: 30px; padding: 20px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3); flex-direction: column; justify-content: space-between; width: 600px; max-width: 80vw; max-height: 60svh; text-align: left;">
      <h2 style="color: var(--primary-color); font-size: 24px;">Your Data. Your Choice.</h2>
      <p style="margin-top: 20px; text-wrap: balance; font-size: 16px;">To enhance your experience on our website and analyze traffic, we utilize functional and analytical cookies. You have the option to decline non-essential cookies. For more details and to adjust your preferences, please visit our <a href="/privacy" style="color: var(--text-color);">Privacy Policy</a>.</p>
      <div style="margin-top: 20px; display: flex; justify-content: center; gap: 20px;">
